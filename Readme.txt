========================================================================
             ZenDesktop Premium One-Key Deploy Package v3.1.0
========================================================================
...
* 🆕 【v3.1.0 桌面自动隐藏重构 (2026/05)】
  - 引入全局 `GetLastInputInfo` 侦测，精准判定系统发呆状态，只有在你彻底不碰键盘和鼠标时才会自动隐藏桌面图标，避免误判。
  - 智能感知手动隐藏：如果你通过“双击”主动隐藏了图标，系统绝不会在动鼠标时擅自把它变出来。
